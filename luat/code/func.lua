...
function crc16(hexs)
    ...
    for i=1,slen(hexs),2 do
        local byte = tonumber(ssub(hexs,i,i+1),16)
        local a = crc16 % 256
        local b = (crc16 - crc16 % 256) / 256
        local c = tab16[bit.bxor(b,byte) + 1]
        local d = bit.bxor((c - c % 256) / 256, a)
        crc16 = d * 256 + c % 256
    end

    return sformat("%04X",crc16)
end
