...
--- 上报pub01信息
function pub01()
    insertMsg("ADE7953/"..misc.getImei().."/out", func.hexstobins("0101"), 1, {cb=pub01Cb})
end
...
--- 上报pub02信息
function pub02()
    insertMsg("ADE7953/"..misc.getImei().."/out", func.hexstobins("0201"), 1, {cb=pub02Cb})
end
...
--- 上报Online信息
function pubOnline()
    insertMsg("ADE7953/"..misc.getImei().."/out", func.hexstobins("0431"..ver2hexs(_G.VERSION)), 1, {cb=pubOnlineCb})
end
